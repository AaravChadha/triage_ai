...
- [x] **3.6 Facility → Summary Integration**
  ...
  - [x] 3.6.2 Selected facility name is passed to PatientSummary's "Send to Facility" button
  - [x] 3.6.3 On send, call `POST /notify` with actual selected facility name instead of placeholder
